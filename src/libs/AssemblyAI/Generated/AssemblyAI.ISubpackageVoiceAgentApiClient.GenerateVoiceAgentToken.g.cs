...
namespace AssemblyAI
{
    public partial interface ISubpackageVoiceAgentApiClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::AssemblyAI.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::AssemblyAI.AutoSDKHttpResponse<global::AssemblyAI.VoiceAgentAPIGenerateVoiceAgentTokenResponse200>> GenerateVoiceAgentTokenAsResponseAsync(
            int expiresInSeconds,
            int? maxSessionDurationSeconds = default,
            global::AssemblyAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default);
