...
namespace AssemblyAI.JsonConverters
{
    ...
    public class TranscriptParamsJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::AssemblyAI.TranscriptParams>
    {
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            if (__jsonProps.Contains("language_detection_options.code_switching")) __score1++;
            if (__jsonProps.Contains("language_detection_options.code_switching_confidence_threshold")) __score1++;
            ...
            if (__jsonProps.Contains("redact_pii_audio_options.override_audio_redaction_method")) __score1++;
            if (__jsonProps.Contains("redact_pii_audio_options.return_redacted_no_speech_audio")) __score1++;
            if (__jsonProps.Contains("redact_pii_audio_quality")) __score1++;
            if (__jsonProps.Contains("redact_pii_policies")) __score1++;
            if (__jsonProps.Contains("redact_pii_return_unredacted")) __score1++;
            if (__jsonProps.Contains("redact_pii_sub")) __score1++;
            if (__jsonProps.Contains("redact_static_entities")) __score1++;
            ...
            if (__jsonProps.Contains("speaker_options.max_speakers_expected")) __score1++;
            if (__jsonProps.Contains("speaker_options.min_speakers_expected")) __score1++;
